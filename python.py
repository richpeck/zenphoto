...
for photo in photos:
    ...
    etree.SubElement(attachment, "pubDate").text = rfc822_date(date1)
    ...
    etree.SubElement(attachment, WP + "post_date").text = date1.isoformat()
    etree.SubElement(attachment, WP + "post_date_gmt").text = date1.isoformat()
...
for album in albums:
    ...
    etree.SubElement(post, "pubDate").text = rfc822_date(date1)
    ...
    etree.SubElement(post, WP + "post_date").text = date1.isoformat()
    etree.SubElement(post, WP + "post_date_gmt").text = date1.isoformat()
